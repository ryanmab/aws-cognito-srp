...
pub static G: std::sync::LazyLock<BigUint> =
    std::sync::LazyLock::new(|| BigUint::from_bytes_be(&[2]));
...
pub static N: std::sync::LazyLock<BigUint> = std::sync::LazyLock::new(|| {
...
pub static DERIVE_KEY_INFO: std::sync::LazyLock<String> =
    std::sync::LazyLock::new(|| String::from("Caldera Derived Key"));
